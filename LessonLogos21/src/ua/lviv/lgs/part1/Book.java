...
public class Book {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        Book book = (Book) o;
        return numberOfPages == book.numberOfPages && yearOfPublishing == book.yearOfPublishing
                && nameOfBook.equals(book.nameOfBook) && authorName.equals(book.authorName);
    }
    ...
    public String toString() {
        return "Book{" + "nameOfBook='" + nameOfBook + '\'' + ", authorName='" + authorName + '\'' + ", numberOfPages="
                + numberOfPages + ", yearOfPublishing=" + yearOfPublishing + '}';
    }
}